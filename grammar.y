...
transicionalesattributes: T_INT T_COMMA  T_STRING  T_COMMA  T_INT
                             ...
                             if (strcmp($3, var1) != 0 && strcmp($3, var2) != 0)
                                {
                                    ...
                                    sprintf(error_message, "One T_STRING at line %d does not match values %s or %s that were entered in T_ALFABETO found %s ", error_line, var1, var2, $3);
                         ...
                         T_INT T_COMMA  T_STRING T_COMMA  T_INT
                         {
                             ...
                             if (strcmp($14, var1) != 0 && strcmp($14, var2) != 0)
                                {
                                    char error_message[100];
                                    sprintf(error_message, "One T_STRING at line %d does not match values %s or %s that were entered in T_ALFABETO found %s ", error_line, var1, var2, $14);
                                    yyerror(error_message);
                                }
                         ...
                         T_INT T_COMMA  T_STRING T_COMMA  T_INT
                         {
                             ...
                             if (strcmp($20, var1) != 0 && strcmp($20, var2) != 0)
                                {
                                    char error_message[100];
                                    sprintf(error_message, "One T_STRING at line %d does not match values %s or %s that were entered in T_ALFABETO found %s ", error_line, var1, var2, $20);
                                    yyerror(error_message);
                                }
                         ...
                         T_INT T_COMMA  T_STRING T_COMMA  T_INT
                         {
                             ...
                             if (strcmp($26, var1) != 0 && strcmp($26, var2) != 0)
                                {
                                    char error_message[100];
                                    sprintf(error_message, "One T_STRING at line %d does not match values %s or %s that were entered in T_ALFABETO found %s ", error_line, var1, var2, $26);
                                    yyerror(error_message);
                                }
                         ...
                         T_INT T_COMMA  T_STRING T_COMMA  T_INT
                         {
                             ...
                             if (strcmp($32, var1) != 0 && strcmp($32, var2) != 0)
                                {
                                    char error_message[100];
                                    sprintf(error_message, "One T_STRING at line %d does not match values %s or %s that were entered in T_ALFABETO found %s ", error_line, var1, var2, $32);
                                    yyerror(error_message);
                                }
